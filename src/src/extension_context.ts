...
/**
 * Provides an extension-specific context passed to the extension's constructor. This is currently
...
/**
 * Provides an extension-specific context passed to the extension's `start` lifecycle event. Currently
