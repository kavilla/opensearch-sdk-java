...
> {
  setup(core: CoreSetup<TExtensionsSetup, TStart>, extensions: TExtensionsSetup): TSetup | Promise<TSetup>;
  start(core: CoreStart, extensions: TExtensionsStart): TStart | Promise<TStart>;
  stop?(): void;
}

/**
 * The `extension` export at the root of an extension's `public` directory should conform
 * to this interface.
 *
 * @public
 */
export type ExtensionInitializer<
  ...
  TExtensionsSetup extends object = object,
  TExtensionsStart extends object = object
> = (core: ExtensionInitializerContext) => Extension<TSetup, TStart, TExtensionsSetup, TExtensionsStart>;
...
> {
   ...
   */
  public async setup(setupContext: CoreSetup<TExtensionsStart, TStart>, extensions: TExtensionsSetup) {
